...
public enum MgagePrioritySmsGatewayStatus implements GatewaySmsStatus {
    ...
    MgagePrioritySmsGatewayStatus(String name, Boolean terminal, GatewaySmsStatusType type){
        this.name = name;
    ...
    public String getSmsGatewayName() {
        return MgagePrioritySmsGatewayHandler.SMS_GATEWAY_NAME;
    }
