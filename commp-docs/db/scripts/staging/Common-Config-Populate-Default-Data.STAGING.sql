...
INSERT INTO `cmn_config_param` (`id`, `name`, `description`, `value_data_type`, `config_target_type_id`) VALUES
  ...
  (NULL, 'RETRY_COUNT','Determines the number of times sms can be retried', 'NUMBER',
                                                     (SELECT id
                                                      FROM cmn_config_target_type
                                                      WHERE type_name = 'SMS_ENGINE')),
  (NULL, 'DEFAULT_GROUP_NAME','Determines which default Sms group to be used.', 'TEXT',
                                                     (SELECT id
                                                      FROM cmn_config_target_type
                                                      WHERE type_name = 'SMS_TYPE')),
  (NULL, 'SMS_MAX_THROTTLING_COUNT','Determines max throttling count for a given sms type. If this value is -1 then throttling is not applicable', 'TEXT',
                                                     (SELECT id
                                                      FROM cmn_config_target_type
                                                      WHERE type_name = 'SMS_TYPE')),
  (NULL, 'SMS_RECEIVED_UPPER_LIMIT_PER_LOT','Determines upper limit on no of sms that can be received in single sms lot', 'NUMBER',
                                                     (SELECT id
                                                      FROM cmn_config_target_type
                                                      WHERE type_name = 'SMS_ENGINE')),
  (NULL, 'MESSAGE_MAX_LENGTH','Determines upper limit on message length for a SMS', 'NUMBER',
                                                     (SELECT id
                                                      FROM cmn_config_target_type
                                                      WHERE type_name = 'SMS_ENGINE'))
;
...
INSERT INTO `cmn_target_config` (`id`, `active`, `target_id`, `config_param_id`) VALUES
  ...
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'DummySmsType1'), (SELECT id
                                           FROM cmn_config_param
                                           WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'internal'), (SELECT id
                                                FROM cmn_config_param
                                                WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'marketing'), (SELECT id
                                           FROM cmn_config_param
                                           WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'alert'), (SELECT id
                                           FROM cmn_config_param
                                           WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'Transactional'), (SELECT id
                                           FROM cmn_config_param
                                           WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'Regular'), (SELECT id
                                            FROM cmn_config_param
                                            WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'Promotional'), (SELECT id
                                        FROM cmn_config_param
                                        WHERE name = 'DEFAULT_GROUP_NAME')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'internal'), (SELECT id
                                        FROM cmn_config_param
                                        WHERE name = 'SMS_MAX_THROTTLING_COUNT')),
  (NULL, b'1', (SELECT id
                FROM smsen_sms_type
                WHERE name = 'marketing'), (SELECT id
                                        FROM cmn_config_param
  ...
  (NULL, b'1', null, (SELECT id
                                                FROM cmn_config_param
                                                WHERE name = 'SMS_RECEIVED_UPPER_LIMIT_PER_LOT')),
  (NULL, b'1', null, (SELECT id
                                                FROM cmn_config_param
                                                WHERE name = 'MESSAGE_MAX_LENGTH'))
;
  ...
  (NULL, '2', (SELECT ctc.id
                      ...
                      WHERE ctc.target_id IS NULL
                            AND ctc.config_param_id = (SELECT id
                                                       FROM cmn_config_param
                                                       WHERE name = 'RETRY_COUNT'))),
  (NULL, 'Default_alert', (SELECT ctc.id
                         FROM cmn_target_config ctc
                         WHERE ctc.target_id = (SELECT id
                                                FROM smsen_sms_type
                                                WHERE name = 'alert')
                               AND ctc.config_param_id = (SELECT id
                                                          ...
                                                          WHERE name =
                                                                'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_internal', (SELECT ctc.id
                         FROM cmn_target_config ctc
                         WHERE ctc.target_id = (SELECT id
                                                FROM smsen_sms_type
                                                WHERE name = 'internal')
                               AND ctc.config_param_id = (SELECT id
                                                          ...
                                                          WHERE name =
                                                                'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_marketing', (SELECT ctc.id
                         FROM cmn_target_config ctc
                         WHERE ctc.target_id = (SELECT id
                                                FROM smsen_sms_type
                               ...
                               AND ctc.config_param_id = (SELECT id
                                                          ...
                                                          WHERE name =
                                                                'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_DummySmsType1', (SELECT ctc.id
                        FROM cmn_target_config ctc
                        WHERE ctc.target_id = (SELECT id
                                               FROM smsen_sms_type
                              ...
                              AND ctc.config_param_id = (SELECT id
                                                         ...
                                                         WHERE name =
                                                               'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_Transactional', (SELECT ctc.id
                                 FROM cmn_target_config ctc
                                 WHERE ctc.target_id = (SELECT id
                                                        FROM smsen_sms_type
                                       ...
                                       AND ctc.config_param_id = (SELECT id
                                                                  ...
                                                                  WHERE name =
                                                                        'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_Regular', (SELECT ctc.id
                            FROM cmn_target_config ctc
                            WHERE ctc.target_id = (SELECT id
                                                   FROM smsen_sms_type
                                                   WHERE name = 'Regular')
                                  AND ctc.config_param_id = (SELECT id
                                                             ...
                                                             WHERE name =
                                                                   'DEFAULT_GROUP_NAME'))),
  (NULL, 'Default_Promotional', (SELECT ctc.id
                         FROM cmn_target_config ctc
                         WHERE ctc.target_id = (SELECT id
                                                FROM smsen_sms_type
                                                WHERE name = 'Promotional')
                               AND ctc.config_param_id = (SELECT id
                                                          FROM cmn_config_param
                                                          WHERE name =
                                                                'DEFAULT_GROUP_NAME'))),
  (NULL, '100', (SELECT ctc.id
               FROM cmn_target_config ctc
               WHERE ctc.target_id = (SELECT id
                                      FROM smsen_sms_type
                                      WHERE name = 'alert')
