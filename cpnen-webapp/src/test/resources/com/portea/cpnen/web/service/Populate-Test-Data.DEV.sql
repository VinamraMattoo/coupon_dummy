  ...
  (`id`, `requester_id`, `beneficiary_id`, `area_id`, `patient_brand_id`, `referrer_id`, `client_context_id`, `client_context_type`, `total_cost`, `latest_updated_on`, `completed`, `status`, `source_name`, `within_subscription`) VALUES
    (1,       1,              1,                1,            1,              1,                NULL,                  'APPOINTMENT',    100,      NOW(),   b'0',   'APPLIED',  'CLINICIAN_APP', b'1'),
    (2,       1,              1,                1,            2,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (3,       2,              2,                1,            3,              1,                '2',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (4,       1,              1,                2,            4,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (5,       1,              1,                3,            5,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (6,       1,              1,                4,            6,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (7,       1,              1,                6,            1,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (8,       1,              1,                4,            2,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (9,       1,              1,                4,            3,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (10,       1,              1,                3,            3,              1,                '1',                  'APPOINTMENT',    100,     NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (11,       1,              1,                5,            3,              1,                '1',                  'APPOINTMENT',    100,      NOW(),    b'1',    'APPLIED',   'CLINICIAN_APP', b'1'),
    (12,       1,              1,                4,            1,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'CANCELED',   'CLINICIAN_APP', b'1'),
    (13,       1,              1,                7,            2,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'CANCELED',   'CLINICIAN_APP', b'1'),
    (14,       1,              1,                3,            3,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'CANCELED',   'CLINICIAN_APP', b'1'),
    (15,       1,              1,                1,            4,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'CANCELED',   'CLINICIAN_APP', b'1'),
    (16,       1,              1,                1,            5,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1'),
    (17,       1,              1,                2,            6,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1'),
    (18,       1,              1,                3,            7,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1'),
    (19,       1,              1,                4,            1,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1'),
    (20,       1,              1,                5,            2,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1'),
    (21,       1,              1,                6,            3,              1,                '1',                  'APPOINTMENT',    100,      DATE_ADD(NOW(),INTERVAL -1 DAY),    b'1',    'REQUESTED',   'CLINICIAN_APP', b'1');
  ...
  (`id`, `coupon_disc_req_id`, `requester_id`, `beneficiary_id`, `patient_brand_id`, `area_id`, `referrer_id`, `client_context_id`, `client_context_type`, `total_cost`, `discount_amount`, `created_on`) VALUES
    (1,         2,                    1,            1,                  1,                1,          1,                '1',            'APPOINTMENT',          100,        10,       NOW()),
    (2,         3,                    2,            2,                  2,                1,          2,                '2',            'APPOINTMENT',          100,        20,       NOW()),
    (3,         4,                    1,            1,                  3,                2,          3,                '1',            'APPOINTMENT',          100,        30,       NOW()),
    (4,         4,                    1,            1,                  4,                3,          4,                '1',            'APPOINTMENT',          100,        40,       NOW()),
    (5,         4,                    1,            1,                  5,                4,          5,                '1',            'APPOINTMENT',          100,        20,       NOW()),
    (6,         4,                    1,            1,                  1,                5,          1,                '1',            'APPOINTMENT',          100,        10,       NOW()),
    (7,         4,                    1,            1,                  2,                1,          2,                '1',            'APPOINTMENT',          100,        11,       NOW()),
    (8,         4,                    1,            1,                  3,                2,          3,                '1',            'APPOINTMENT',          100,        12,       NOW()),
    (9,         4,                    1,            1,                  4,                1,          4,                '1',            'APPOINTMENT',          100,        13,       NOW()),
    (10,         4,                    1,            1,                  1,                2,          1,                '1',            'APPOINTMENT',          100,        25,       NOW()),
    (11,         5,                    1,            1,                  1,                1,          1,                '1',            'APPOINTMENT',          100,        45,       NOW());